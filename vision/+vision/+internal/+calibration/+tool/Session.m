...
classdef Session < handle
    ...
    methods(Access=private)
        ...
        function codeString = generateCodeSingle(this)
            ...
            codeGenerator.addLine(sprintf('h1=figure; showReprojectionErrors(cameraParams, ''%s'');', ...
                this.ErrorsView));
        ...
        function codeString = generateCodeStereo(this)
            ...
            % Reprojection errors
            codeGenerator.addComment('View reprojection errors');            
            codeGenerator.addLine(sprintf('h1=figure; showReprojectionErrors(stereoParams, ''%s'');', ...
                this.ErrorsView));
    ...
    methods (Static, Hidden)
        ...
        function this = loadobj(that)
            if isa(that, 'vision.internal.calibration.tool.Session')
                ...
                this.ErrorsView         = that.errorsView;
