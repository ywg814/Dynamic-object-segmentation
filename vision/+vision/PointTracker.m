...
%#ok<*EMCA>
  ...
  properties (Hidden, Access = private, Nontunable)
    % If the image is RGB use ColorConverter to covert it to grayscale.
    ColorConverter;
  end
  ...
  methods
    ...
    function obj = PointTracker(varargin)
      ...
      % no need to call setupImpl to get System object handle
      obj.ColorConverter  = vision.ColorSpaceConverter('Conversion', ...
                                 'RGB to intensity'); % input always uint8  
  ...
  methods(Access=protected)
    ...
    function [points, pointValidity, scores] = stepImpl(obj, I)
      ...
      coder.internal.errorIf(~strcmp(class(I), obj.FrameClass), ...
      ...
      if size(I, 3) > 1
          ...
          Iu8_gray = step(obj.ColorConverter, Iu8);
      else
          Iu8_gray = Iu8;
          coder.internal.errorIf(obj.IsRGB, ...
      ...
      if (isSimMode())
          [points, pointValidity, scores] = obj.pTracker.step(Iu8_gray);
      else
          [points, pointValidity, scores] = ...
      ...
      badPoints = pointsOutsideImage(obj, points);
      ...
      if isSimMode()
          ...
          points = cast(points, obj.PointClass);
      end
    end    
    ...
    function s = saveObjectImpl(obj)
        ...
        s.IsRGB = obj.IsRGB;
        s.PointClass = obj.PointClass;
        s.FrameClass = obj.FrameClass;
    ...
    function loadObjectImpl(obj,s,~)
        ...
        obj.IsRGB = s.IsRGB;
        obj.PointClass = s.PointClass;        
        obj.FrameClass = s.FrameClass;
  ...
  methods
    function initialize(obj, points, I)
      ...
      obj.PointClass = class(points);
      
      % conversion from 1-based to 0-based is done in
      % vision.internal.PointTracker
      points = single(points);
      
      obj.FrameClass = class(I);
    ...
    function setPoints(obj, points, pointValididty)
      ...
      if isSimMode()
        coder.internal.errorIf(isLocked(obj) && ...
            ~strcmp(obj.PointClass, class(points)),...
