...
classdef bagOfFeatures < vision.internal.EnforceScalarHandle & matlab.mixin.CustomDisplay
    ...
    methods (Access = public)
        ...
        function [featureVector, varargout] = encode(this, in, varargin)
            ...
            isImageSet = isa(in, 'imageSet');
            
            params = bagOfFeatures.parseEncodeInputs(isImageSet, varargin{:});
    ...
    methods (Hidden, Access = protected)
        ...
        function [features, varargout] = encodeScalarImageSet(this, imgSet, params)
            ...
            features = bagOfFeatures.allocateFeatureVector(imgSet.Count, this.VocabularySize, params.SparseOutput); 
            words    = bagOfFeatures.allocateVisualWords(imgSet.Count);
    ...
    methods (Hidden, Static, Access = protected)
        ...
        function checkImageSet(imgSet)
            ...
            validateattributes(imgSet, {'imageSet'}, {'nonempty'},...
                mfilename, varName);
        ...
        function [imgSets, params] = parseInputs(varargin)                     
            ...
            parser = inputParser;
            parser.addRequired('imgSets', @bagOfFeatures.checkImageSet);
