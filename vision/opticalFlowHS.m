...
%#ok<*MCSUP>
  ...
  methods
    ...
    function obj = opticalFlowHS(varargin)
      ...
      checkSmoothness(tmpSmoothness);
      checkMaxIteration(tmpMaxIteration);
      checkVelocityDifference(tmpVelocityDifference);
      
      obj.Smoothness = tmpSmoothness;
      obj.MaxIteration = int32(tmpMaxIteration);
    ...
    function outFlow = estimateFlow(obj, ImageA) %, varargin)
     ...
     %obj.pImageClass = coder.const(class(ImageA));
