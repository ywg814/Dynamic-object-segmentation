...
%
% Example - Display stereo camera calibraiton errors
% --------------------------------------------------
%
    ...
    methods(Access=private)
        ...
        function displayInterCameraGeometry(this, stereoParams)
            ...
            rotationVectorsString{1} = sprintf(entryFormat,...
                stereoParams.RotationOfCamera2(1), ...
                this.RotationOfCamera2Error(1));
            
            rotationVectorsString{2} = sprintf(entryFormat,...
                stereoParams.RotationOfCamera2(2), ...
                this.RotationOfCamera2Error(2));
            
            rotationVectorsString{3} = sprintf(entryFormat,...
                stereoParams.RotationOfCamera2(3), ...
                this.RotationOfCamera2Error(3));
