...
%     detectBRISKFeatures, matchFeatures
...
validateattributes(I,{'logical', 'uint8', 'uint16', 'int16', 'single',...
    'double'}, {'2d', 'nonempty', 'nonsparse', 'real'}, ...
    mfilename, 'I', 1); 
...
%==========================================================================
% Correct the orienation returned from OpenCV such that it is measured
