...
%   % <a href="matlab:web(fullfile(matlabroot,'toolbox','vision','visiondemos','html','videorectification.html'))">View example</a>
% 
% See also estimateFundamentalMatrix, isEpipoleInImage, imwarp,
