...
%   Class Support
%   -------------
%   disparityMap can be double or single. pointCloud is double if 
...
function pointCloud = reconstructScene(disparityMap, stereoParams)
...
pointCloud = reconstructSceneImpl(stereoParams, disparityMap);
