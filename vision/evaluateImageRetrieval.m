...
% similar to queryImage and the similarity scores.
%
...
% ----------------------------------------------------
% 
% % Create a image set of book covers
% dataDir = fullfile(toolboxdir('vision'),'visiondata', 'bookCovers');
% bookCovers = imageSet(dataDir);
% 
% imageIndex = indexImages(bookCovers);   % This will take a few minutes.
...
% 
% See also retrieveImages, indexImages, invertedImageIndex.
