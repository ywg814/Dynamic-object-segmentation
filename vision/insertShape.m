...
parser.addParameter('LineWidth',defaults.LineWidth,@checkLineWidth);
parser.addParameter('Color',defaults.Color);
parser.addParameter('Opacity',defaults.Opacity,@checkOpacity);
parser.addParameter('SmoothEdges',defaults.smoothEdges,@checkSmoothEdges);
