...
%   .xml extension. 
%
%   positiveInstances is an array of structs with information 
%   about the positive instances. To create this struct, use
%   trainingImageLabeler app. The struct fields are:
...
%   rate.
%
%   negativeImages is either the path to a folder containing images or a 
%   cell array of image file names. The images are used to generate negative 
%   samples, and thus must not contain any objects of interest. Instead,
%   they should contain backgrounds associated with the object. 
%
...
%
%    See also trainingImageLabeler, vision.CascadeObjectDetector, insertObjectAnnotation
...
% Check that the working directory is writeable
...
% Valid outputXmlFilename must not have a foldername attached to it
