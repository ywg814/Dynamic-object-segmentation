...
%#ok<*MCSUP>
  ...
  methods
    ...
    function obj = opticalFlowLKDoG(varargin)
      ...
      checkNumFrames(tmpNumFrames);
      checkSigma(tmpImageFilterSigma, 'ImageFilterSigma');
      checkSigma(tmpGradientFilterSigma, 'GradientFilterSigma');
      checkNoiseThreshold(tmpNoiseThreshold);
      ...
      %obj.DiscardIllConditionedEstimates = tmpDiscardIllConditionedEstimates;
